  ...
  <body style="word-spacing:normal;background-color:#f0f1f3;">
    ...
    <!-- Logo Header -->
      ...
      ><p style="
              ...
              line-height: 1.4;
              margin-top:2px;
            ">Did you know that the King of England receives daily updates on government affairs through a red dispatch box every morning?</p>
          <p style="
              font-size: 16px;
              line-height: 1.4;
            ">Welcome to <strong><i>Geopolitics World!</i></strong></p></div>
