...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style type="text/css">
    h2, img, p { margin: 0; } td { padding-top: 0 !important; } p { margin-bottom: 10px; }/* Hover effect for buttons */ .button-style:hover { background-color: #fff !important; color: #5452DA !important; border: 1px solid #5452DA !important;}
    </style>
  ...
  <body style="word-spacing:normal;background-color:#f0f1f3;">
      ...
      >
        <div style="display: none; max-height: 0px; overflow: hidden;">Understand the forces shaping the world.</div>
    ...
    <!-- Logo Header -->
      ...
      <img
         alt="" height="auto" src="https://www.geopolitics.world/gp-logo-grey.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180"
      />
                                      ...
                                      <tr>
                                        <td style="width: 1px">
                                          <img
                                            alt=""
                                            height="auto"
                                            src="https://www.geopoliticalsummary.com/api/emails/emails_list_open?user_uniqueid=%unique-id%&email_uniqueid=%email_uniqueid%"
                                            style="
                                              border: 0;
                                              display: block;
                                              outline: none;
      ...
      <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="mj_fsection-outlook" role="presentation" style="width:600px;" width="600" bgcolor="#ffffff" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
      ...
      <img
         alt="gif not there" height="auto" src="https://www.geopoliticalsummary.com/gs-transparant-verify.gif" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200"
      />
      ...
      ><h2 style="text-align:center;font-size:29px; font-weight:600px; color:#000; line-height:150%;"> Verify your email</h2></div>
      ...
      <div
         style="font-family:Roboto+Serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><p style="width:80%; margin: 0 auto; text-align:center; font-size:16px; color: #000; line-height:150%;font-weight:300"> Hit the button below to <span style="color:#000; font-weight:600">verify</span> your email and start getting your daily dose of Geopolitical Summary. </p></div>
      ...
      <div
         style="font-family:Roboto;font-size:13px;line-height:1;text-align:center;color:#000000;"
      ><a href="https://www.geopoliticalsummary.com/verified?uniqueid=%unique-id%&email_uniqueid=%email_uniqueid%" class="button-style" style="
    ...
    <!-- 2 columns section -->
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:10px 12px;word-break:break-word;"
                >
      ...
      ><p style="
              ...
              font-size:12px;
              line-height: 2;
            ">Send us your feedback at <a style="text-decoration: none; border-bottom: 2px solid  #06266D; color: black;" href="mailto:readers@geopoliticalsummary.com" target="_blank">readers@geopoliticalsummary.com</a>. </p>
          <p style="
              color:#000;
              font-size:12px;
              line-height: 2;
            "> Interested in connecting with curious, informed readers? <a style="text-decoration: none; border-bottom: 2px solid  #06266D; color: black;" href="https://www.geopoliticalsummary.com/advertise#advertise-form" target="_blank">Advertise with us</a>.</p>
          <p style="
              color:#000;
              font-size:12px;
              line-height: 2;
            ">
            <a style="text-decoration: none; border-bottom: 2px solid  #06266D; color: black;" href="https://www.geopoliticalsummary.com/unsubscribe?uniqueid=%unique-id%&email_uniqueid=%email_uniqueid%" target="_blank">Unsubscribe</a> from this email.
          </p></div>
     ...
     <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" ><tr><![endif]-->
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.facebook.com/profile.php?id=61562847449514" target="_blank">
                    <img
                       height="24" src="https://www.geopoliticalsummary.com/icons/social/facebook.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://x.com/readgeopolitics" target="_blank">
                    <img
                       height="24" src="https://www.geopoliticalsummary.com/icons/social/x.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
        ...
        <td  style="padding:12px 10px;vertical-align:middle;">
          ...
          >
            <tbody>
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.instagram.com/geopoliticalsummary/" target="_blank">
                    <img
                       height="24" src="https://www.geopoliticalsummary.com/icons/social/instagram.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
        ...
        <td  style="padding:12px 10px;vertical-align:middle;">
          ...
          >
            <tbody>
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.linkedin.com/showcase/geopoliticalsummary/" target="_blank">
                    <img
                       height="24" src="https://www.geopoliticalsummary.com/icons/social/linkedin.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
        ...
        <td  style="padding:12px 10px;vertical-align:middle;">
          ...
          >
            <tbody>
              <tr>
                <td  style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                  <a  href="https://www.threads.net/@geopoliticalsummary" target="_blank">
                    <img
                       height="24" src="https://www.geopoliticalsummary.com/icons/social/threads.png" style="border-radius:3px;display:block;" width="24"
                    />
                  </a>
                </td>
              </tr>
      ...
      ><p style="
              ...
              color: #667085;
              line-height: 1.5;
            ">30 <span>N</span> <span>Gould</span> <span>St, Ste N, Sheridan, WY 82801, United States</span></p>
          <p style="
              text-align:center;
              font-size:10px;
              color: #667085;
