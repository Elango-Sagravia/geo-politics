...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-nl_sec_background px-4 md:px-16 py-5 flex justify-between items-center border-b border-nl_button_border z-50">
      <Link href="/">
